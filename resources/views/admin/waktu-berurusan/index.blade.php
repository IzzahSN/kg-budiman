    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Senarai Waktu Berurusan</h2>
                <a href="{{ route('admin.waktu-berurusan.create') }}" class="inline-block px-4 py-2 text-sm bg-secondary text-white rounded-lg shadow hover:bg-primary-dark transition duration-300 transform hover:scale-[1.02]">
                    Tambah Waktu Berurusan
                </a>
            </div>
                ...
                <table class="min-w-full bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-md">
                    <thead class="bg-gray-100 dark:bg-gray-800">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Waktu Berurusan</th>
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">Isnin-Khamis</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">8:00 AM hingga 6:00 PM</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('admin.waktu-berurusan.edit', 1) }}" class="text-indigo-600 hover:text-indigo-900 mr-4">Edit</a>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">Jumaat</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">8:00 AM hingga 12:30 PM</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('admin.waktu-berurusan.edit', 1) }}" class="text-indigo-600 hover:text-indigo-900 mr-4">Edit</a>
                                    <form action="#" method="POST" class="inline">
                                        @csrf
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">Sabtu & Ahad</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">10:00 AM hingga 4:00 PM</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('admin.waktu-berurusan.edit', 1) }}" class="text-indigo-600 hover:text-indigo-900 mr-4">Edit</a>
                                    <form action="#" method="POST" class="inline">
                                        @csrf
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">Cuti Umum</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">Cuti</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('admin.waktu-berurusan.edit', 1) }}" class="text-indigo-600 hover:text-indigo-900 mr-4">Edit</a>
                                    <form action="#" method="POST" class="inline">
                                        @csrf
