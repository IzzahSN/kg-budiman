    ...
    <div class="p-4 sm:p-6 lg:p-8">
       ...
       <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Kemaskini Fasiliti</h2>
            ...
            <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route('admin.fasiliti.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:underline">Kembali ke Senarai</a>
