    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.fasiliti.create') }}" class="inline-block px-4 py-2 text-sm bg-secondary text-white rounded-lg shadow hover:bg-primary-dark transition duration-300 transform hover:scale-[1.02]">
                    Tambah Fasiliti
                </a>
            </div>
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <img class="h-15 w-30 bg-primary/20">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">Padang Bola</td>
