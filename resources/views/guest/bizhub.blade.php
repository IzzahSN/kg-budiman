<x-app-layout :title="'Budiman Biz HUB'">
    ...
    <!-- listkan perniagaan -->
    @php
    // Define the gradient using tailwind arbitrary values
    $gradientClass = "bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-tertiary)]";

    // Define the hover gradient to lighter colors using tailwind arbitrary values
    $gradientHoverClass = "hover:from-[var(--color-primary-light)] hover:to-[var(--color-tertiary-light)]";
@endphp
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden transform hover:scale-[1.02] transition duration-300 ease-in-out border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <button class="w-full mt-6 px-4 py-3 rounded-lg text-white font-semibold shadow-md transition duration-300 ease-in-out {{ $gradientClass }} {{ $gradientHoverClass }} focus:outline-none focus:ring-4 focus:ring-opacity-50 focus:ring-primary">
                        Klik untuk tempahan
                    </button>
                </div>
            </div>
